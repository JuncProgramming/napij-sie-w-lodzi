      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-start gap-3">
          ...
          <button
            ...
            className="size-11 flex-shrink-0 cursor-pointer rounded-full p-1 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-slate-200 dark:hover:bg-gray-700"
            aria-label={
        ...
        <div className="space-y-1">
          <div className="flex items-start gap-2">
            <div className="mt-[0.1875rem]">{getStatusIcon(isWorking)}</div>
          ...
          <div className="flex items-start gap-2">
            <div className="mt-[0.1875rem]">{getStatusIcon(isAccessible)}</div>
            <span className="text-sm leading-relaxed text-gray-600 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] dark:text-gray-300">
              Dostosowany do osób z niepełnosprawnością
            </span>
          </div>
        </div>
