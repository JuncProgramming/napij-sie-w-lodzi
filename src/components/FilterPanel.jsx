    ...
    <div className="absolute top-16 right-4 z-[1000] max-h-[calc(100vh-8rem)] w-80 overflow-y-auto rounded-lg border border-blue-100 bg-blue-50 p-4 shadow-xl transition-colors duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] dark:border-gray-700 dark:bg-gray-800">
      <div className="mb-4 flex items-center justify-between">
        ...
        <button
          ...
          className="text-sm text-blue-500 transition-colors duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
          Wyczyść wszystkie
        </button>
      </div>
        ...
        <div className="space-y-2">
          <label className="flex items-center">
            <input
              ...
              className="mr-2 h-4 w-4 rounded border-blue-200 text-blue-600 transition-colors duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] focus:ring-blue-500 dark:border-gray-600"
            />
            <FontAwesomeIcon
              icon={faMapMarkerAlt}
      ...
      <div className="flex gap-2 pt-2">
        <button
          onClick={onClose}
          className="flex-1 rounded-md bg-blue-100 px-4 py-2 text-sm font-medium text-blue-800 transition-colors duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-blue-200 dark:bg-gray-600 dark:text-gray-300 dark:hover:bg-gray-500">
          Zamknij
        </button>
      </div>
